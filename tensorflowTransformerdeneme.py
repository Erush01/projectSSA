...
from ssaUtils import get_summary_str,train_table,DiscreteWaveletTransform,DelayedExponentialDecay,save_evaluated_lc_plots,pad_to_size_interpolate
import  argparse
#Tensorflow settings
...
def create_transformer_model(input_shape, num_classes):
    ...
    # Initial feature extraction with 1D convolution
    ...
    for _ in range(3):
        x = TransformerEncoderLayer(
            ...
            num_heads=4, 
            dff=256
        )(x, training=True)  # Explicitly pass training flag
