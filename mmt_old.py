    ...
    def multiprocess_read(self):
        ...
        with Live(self.progressBar.progress_table, refresh_per_second=10):
            for cls in self.mainClasses:
                ...
                picklefile=open(f"ssaDataset-{cls}-{satNum[mid]}.pickle","wb")
                folder=os.path.join(self.DATASET_FOLDER,cls)
...
if __name__ == "__main__":
    mmt=MiniMegaTortoraDataset(periodic=True,satNumber=[100,200,300])
    # mmt=MiniMegaTortoraDataset(periodic=True,satNumber=[10,10,10])
